...
%  create model
Param = ay_create_state_space(1,0,5,0,[1;1],[1 2],[0 1],[],[]);
% set learning parameters
Iter  = 250;
Param = ay_set_learning_param(Param,Iter,0,1,1,1,1,1,1,2,1);
...
[XSmt,SSmt,Param,XPos,SPos,ML,Yp]=ay_em([2 0],[],In,[],Yk,[],Param,valid);

[cov_state,cov_obs]=ay_param_covariance_info([2 0],[],In,[],Yk,[],Param,valid,XSmt,SSmt);
