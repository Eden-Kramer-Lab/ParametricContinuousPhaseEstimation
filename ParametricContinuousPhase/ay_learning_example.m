...
%  create model
Param = ay_create_state_space(1,1,2,2,eye(1,1),1,1,1,0);
% set learning parameters
Iter  = 20;
Param = ay_set_learning_param(Param,Iter,0,1,1,1,1,1,1,1,0);

Param = ay_set_censor_threshold_proc_mode(Param,log(2),1,1);
 
%% Format the Data
%% Run learning with Gamma model
[XSmt,SSmt,Param,XPos,SPos,ML,YP,YB]=ay_em([1 1],Uk,In,Ib,Yn,Yb,Param,Valid);
...
plot(find(isnan(Yn)),0.5,'kx','LineWidth',2); 
grid minor
hold off;
axis tight
